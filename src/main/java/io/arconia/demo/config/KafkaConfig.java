...
import io.arconia.demo.kafka.BookEvent;
...
/**
 * Kafka configuration for Spring Kafka.
 * Configures producer, consumer, and topic settings.
 */
@Configuration
public class KafkaConfig {
    ...
    public ConsumerFactory<String, BookEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props,
            ...
            new JsonDeserializer<>(BookEvent.class));
    }
